...
def train(model, train_loader, optimizer, criterion, configs):
    ...
    for x, y in train_loader:
        ...
        recon_x, mu, logvar, y_pred = model(x, y)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', type=str, default="VAE_pure_01", help='Run multiple times and save ')
    parser.add_argument('--notes', type=str, default="VAE_pure第1次尝试", help='Run multiple times and save ')
